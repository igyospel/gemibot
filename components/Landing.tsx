    ...
    <div className="flex flex-col w-full overflow-hidden">
      ...
      <section className="relative min-h-[85vh] flex flex-col justify-center items-center pb-20">
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10 px-4">
          ...
          <div className="relative h-[600px] flex items-center justify-center perspective-[2000px] group animate-float">
             {/* Main Card */}
             <div className="relative w-[340px] h-[640px] bg-[#050505] rounded-[3rem] border border-white/10 shadow-2xl transform rotate-y-[-12deg] rotate-x-[5deg] group-hover:rotate-y-0 group-hover:rotate-x-0 transition-transform duration-700 ease-out overflow-hidden z-20">
